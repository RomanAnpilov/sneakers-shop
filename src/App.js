...
function App() {
  ...
  React.useEffect(() => {
    async function fetchData() {
      const cartResponse = await axios.get("https://61895903d0821900178d793f.mockapi.io/cart");
      const favoritesResponse = await axios.get("https://61895903d0821900178d793f.mockapi.io/favorite");
      const itemsResponse = await axios.get("https://61895903d0821900178d793f.mockapi.io/items");
